class Task:
    def __init__(self, complete): # Creamos atributos de clase "task"
    ...
    def task_manage (self): # Método que pasa tareas a "completadas"
        ...
        try:
            ...
            print("Error: No existe esa tarea") # Generamos excepción por si el usuario teclea tarea no existente
    ...
    def del_task (self): # Método que elimina tarea
        ...
        try:
          ...
          if task_type == "2":
            ...
            print("Error: opción incorrecta") # Generamos excepción por si el usuario teclea tarea no existente


task_instance = Task(True) # Creamos instancia de la clase "task"
...
while True:
    ...
    try:
        if action == "1": 
            ...
            task_instance.add_task() # Ejecuta método que imprime las tareas
